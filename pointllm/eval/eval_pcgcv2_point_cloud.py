...
def init_model(args):
    ...
    model = PointLLMLlamaForCausalLM.from_pretrained(model_name, low_cpu_mem_usage=False, use_cache=True, torch_dtype=torch.bfloat16).to('mps')
...
if __name__ == "__main__":
    ...
    # * dataset type
    parser.add_argument("--data_path", type=str, default="data/compressed_PCGCv2_data", required=False)
    parser.add_argument("--anno_path", type=str, default="data/anno_data/3Dpoint_cloud.json", required=False)
