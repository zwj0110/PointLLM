...
class TrainOptionHandler(BasicOptionHandler):
    ...
    def add_options(self, parser):
        ...
        parser.add_argument('--scaling_ratio', type=float, required=True, help='[GRASP] Scaling ratio.')
        parser.add_argument('--point_mul', type=int, required=True, help='[GRASP] Point multiplication parameter.')
        parser.add_argument('--skip_mode',  type=str2bool, nargs='?', required=True, const=True, default=False, help='[GRASP] Skip mode or not.')
